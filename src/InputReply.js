...
export default function InputReply(props){
    ...
    return(
        <>
        <input type='text' placeholder='댓글을 입력해주세요.' value={reply} style={{width : '94%', border : 'none', outline : 'none'}} onChange={inputReply}></input>
        <button onClick={sendReply} style={{width   :   '5%'}}>✍️</button>
        </>
    )
}